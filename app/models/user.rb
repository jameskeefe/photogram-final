...
class User < ApplicationRecord
  ...
  has_many(:accepted_sent_follow_requests, -> { follow_accepted}, class_name: "FollowRequest", foreign_key: "sender_id", primary_key: "id")
  ...
  has_many(:accepted_received_follow_requests, -> { follow_accepted}, class_name: "FollowRequest", foreign_key: "recipient_id", primary_key: "id")
